		...
		<transition name="fadeIn05">
			<div id="img-viewer" class="img-viewer" v-show="imgViewer.isShowImgViewer" onclick="util.ui.hideImgViewer()">
				<div class="img-wrap" id="img-wrap" 
					...
					<div class="img-div" :key="index" v-for="(item, index) in imgViewer.imgSrcList" v-bind:style="{backgroundImage: 'url(' + item + ')'}"></div>
				</div>
				<div class="img-circle-wrap" v-show="imgViewer.imgSrcList.length > 1">
					<div class="img-circle" :key="index" v-for="(item, index) in imgViewer.imgSrcList" v-bind:class="{'img-circle-active': index == imgViewer.nowActiveIndex}"></div>
				</div>
